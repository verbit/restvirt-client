...
const (
	HostService_CreateBootstrapToken_FullMethodName = "/HostService/CreateBootstrapToken"
	HostService_GetHost_FullMethodName              = "/HostService/GetHost"
	HostService_ListHosts_FullMethodName            = "/HostService/ListHosts"
	HostService_Register_FullMethodName             = "/HostService/Register"
	HostService_Deregister_FullMethodName           = "/HostService/Deregister"
	HostService_Heartbeat_FullMethodName            = "/HostService/Heartbeat"
)
...
func (c *hostServiceClient) CreateBootstrapToken(ctx context.Context, in *CreateBootstrapTokenRequest, opts ...grpc.CallOption) (*CreateBootstrapTokenResponse, error) {
	...
	err := c.cc.Invoke(ctx, HostService_CreateBootstrapToken_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *hostServiceClient) GetHost(ctx context.Context, in *Host, opts ...grpc.CallOption) (*Host, error) {
	out := new(Host)
	err := c.cc.Invoke(ctx, HostService_GetHost_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *hostServiceClient) Register(ctx context.Context, in *RegisterHostRequest, opts ...grpc.CallOption) (*Host, error) {
	out := new(Host)
	err := c.cc.Invoke(ctx, HostService_Register_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *hostServiceClient) Deregister(ctx context.Context, in *Host, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, HostService_Deregister_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *hostServiceClient) Heartbeat(ctx context.Context, in *HeartbeatRequest, opts ...grpc.CallOption) (*HeartbeatResponse, error) {
	...
	err := c.cc.Invoke(ctx, HostService_Heartbeat_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _HostService_CreateBootstrapToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HostService_CreateBootstrapToken_FullMethodName,
	}
...
func _HostService_Deregister_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HostService_Deregister_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
